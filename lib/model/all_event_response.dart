...
//
// class AllEventResponse {
//   List<EventsResult> eventResult;
//
//   AllEventResponse({this.eventResult});
//
//   AllEventResponse.fromJson(Map<String, dynamic> json) {
//     if (json['result'] != null) {
//       eventResult = <EventsResult>[];
//       json['result'].forEach((v) {
//         eventResult.add(new EventsResult.fromJson(v));
//       });
//     }
//   }
//
...
//       data['result'] = this.eventResult.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
// }
